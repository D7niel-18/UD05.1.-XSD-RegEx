...
- Numero telefono: Usa esta expresion ^[0-9]{3}[\s][0-9]{3}[\s][0-9]{3}$. Que significa que empieza una cadena de caracteres entre 0 y 9 exactamente 3 veces luego hay un espacio en blanco y se vuelve a repetir una cadena entre 0 y 9 exactamente 3 veces asi sucesivamente hasta llegar al $ que significa fin de la cadena esto evita que se haya mas caracteres despues.
